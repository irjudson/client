 ...
 * @param {Object} callback Callback with the blob.
 *   @param {Object} callback.err If the load of the blob fails, this contains the error.
 *   @param {Object} callback.blob The blob metadata from the passed file. 
 **/
 ...
 *   @param {Object} callback.err If the load of the blob fails, this contains the error.
 *   @param {Object} callback.blob The updated blob metadata. 
 **/
 ...
 * @param {Object} callback
 *   @param {Object} callback.err If the load of the blob fails, this contains the error.
 *   @param {Object} callback.resp The response object from the request.
 *   @param {Object} callback.blobData The blob's data. 
 **/
