...
CommandManager.prototype.start = function(session, filter, messages) {
    this.session = session;
    this.pause();

    nitrogen.Message.find(session, filter, { sort: { ts: 1 } }, function(err, messages) {
