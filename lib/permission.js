...
Permission.prototype.create = function(session, callback) {
    session.post({ url: session.service.config.permissions_endpoint, json: this }, function(err, resp, body) {
...
Permission.prototype.remove = function(session, callback) {
    ...
    session.remove({ url: session.service.config.permissions_endpoint + "/" + this.id }, function(err) {
...
Permission.prototype.save = function(session, callback) {
    ...
    session.put({ url: session.service.config.permissions_endpoint + "/" + this.id, json: this }, function(err, resp, body) {
        if (err) return callback(err);
